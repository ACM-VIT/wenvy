/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc apps/web-worker/src/worker/worker-configuration.d.ts` (hash: 3f263d3535db6fa4db6471882955e0ed)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AuthTokenCoordinator" | "RepoBranchCoordinator";
	}
