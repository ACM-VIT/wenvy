/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc apps/web-worker/src/worker/worker-configuration.d.ts` (hash: 5887ddf62117e055de659b49388d3df3)
// Runtime types generated with workerd@1.20260611.1 2026-06-13 nodejs_compat
interface __BaseEnv_Env {
	WENVY_CONFIG_CACHE: KVNamespace;
	WENVY_BLOBS: R2Bucket;
	WENVY_LOGS: R2Bucket;
	WENVY_DB: Hyperdrive;
	GITHUB_SYNC_QUEUE: Queue;
	AUDIT_QUEUE: Queue;
	ENVELOPE_CHECK_QUEUE: Queue;
	EMAIL_QUEUE: Queue;
	ROTATION_QUEUE: Queue;
	AUTH_TOKEN_COORDINATOR: DurableObjectNamespace<import("./worker-entry").AuthTokenCoordinator>;
	REPO_BRANCH_COORDINATOR: DurableObjectNamespace<import("./worker-entry").RepoBranchCoordinator>;
	RATE_LIMIT_COORDINATOR: DurableObjectNamespace<import("./worker-entry").RateLimitCoordinator>;
	GITHUB_DELIVERY_COORDINATOR: DurableObjectNamespace<import("./worker-entry").GithubDeliveryCoordinator>;
	KEY_ROTATION_WORKFLOW: Workflow<Parameters<import("./worker-entry").RotationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker-entry");
		durableNamespaces: "AuthTokenCoordinator" | "RepoBranchCoordinator" | "RateLimitCoordinator" | "GithubDeliveryCoordinator";
	}
